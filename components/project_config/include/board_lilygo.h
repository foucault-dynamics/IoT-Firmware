/*
 * Pin map for the LilyGo / TTGO ESP32 LoRa board used as both the substation
 * relay and the gateway. Values are carried over unchanged from the Arduino
 * firmware, so the wiring assumptions are identical.
 */
